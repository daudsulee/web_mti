...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>PT. Mitra Toyotaka Indonesia</title>
    ...
    <body class="">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <a class="brand" href="#"><span class="first"></span> <span class="second">Mitra Toyotaka Indonesia</span></a>
            </div>
        </div>
        ...
        <div class="sidebar-nav">
            ...
            <ul id="dashboard-menu" class="nav nav-list collapse in">
                <li ><a href="?page=tambahproduk">List Product</a></li>
                <li ><a href="?page=listspek">Product Detail</a></li>
            </ul>
